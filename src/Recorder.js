  ...
  render() {
    return (
      <div>
        ...
        <br></br>
        <button
          style={{ backgroundColor: "#00344E", border: "none" }}
          onClick={this.start}
        >
          <h3 style={{ color: "#b2dfee" }}> Enroll now </h3>{" "}
        </button>
        <br></br>
        <br></br>
        <div hidden={!this.state.enrollmentProgress}>
          <h3>Enrolling</h3>
          <h3>Please give 30 seconds of voice sample</h3>
          <h3>(on any topic)</h3>
          <br></br>
          <img src={process.env.PUBLIC_URL + "/recorder.gif"} alt="My Image" />
        </div>
        <br></br>
        <div hidden={!this.state.enrollCall}> Submitting enrollment data</div>
        <br></br>
